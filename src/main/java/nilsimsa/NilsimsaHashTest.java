...
//		Nilsimsa nilsimsa = new Nilsimsa("int");
//		Nilsimsa nilsimsa2 = new Nilsimsa("��˾������");
//		String hash1 = nilsimsa.toHexDigest();
//		String hash2 = nilsimsa2.toHexDigest();
//		System.out.println(hash1);
//		System.out.println(hash1+'\n'+hash2+nilsimsa.compare(hash1, hash2));
	}
